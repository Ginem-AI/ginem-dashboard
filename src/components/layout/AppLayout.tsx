...
export default function AppLayout() {
  ...
  const menuItems = [
    { title: "Dashboard", link: ROUTES.home, icon: <IconMenus.dashboard /> },
    { title: "Devices", link: ROUTES.devices, icon: <IconMenus.device /> },
    {
      title: "Scheduler",
    ...
    { title: "Logger", link: ROUTES.logger, icon: <IconMenus.logger /> },
    { title: "Admin", link: ROUTES.admins, icon: <IconMenus.admin /> },
    {
      title: "Settings",
      link: ROUTES.settings,
      icon: <IconMenus.settings />,
    },
    { title: "Profile", link: ROUTES.profile, icon: <IconMenus.profile /> },
  ];
